...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements hello.webservice.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/Hello-WebService/services/HelloWorld";
    ...
    public hello.webservice.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public hello.webservice.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            hello.webservice.HelloWorldSoapBindingStub _stub = new hello.webservice.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (hello.webservice.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                hello.webservice.HelloWorldSoapBindingStub _stub = new hello.webservice.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.hello", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.hello", "HelloWorld"));
        }
