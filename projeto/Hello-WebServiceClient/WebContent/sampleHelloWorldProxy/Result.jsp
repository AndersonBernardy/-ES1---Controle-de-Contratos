...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="hello.webservice.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        hello.webservice.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
...
case 13:
        gotMethod = true;
        java.lang.String sayHello13mtemp = sampleHelloWorldProxyid.sayHello();
